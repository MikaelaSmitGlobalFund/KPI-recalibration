...
write.csv(df_hiv_rate_red, file=file.path(output_path,"df_hiv_rate_diff_forQA.csv"), na = "", row.names=FALSE)
...
# Save the final output
write.csv(df_tb_rate_red, file=file.path(output_path,"df_tb_rate_diff_forQA.csv"), na = "", row.names=FALSE)
...
# Save the final output
write.csv(df_malaria_rate_red, file=file.path(output_path,"df_mal_rate_diff_forQA.csv"), na = "", row.names=FALSE)
...
# Save for QA
df_hiv_qa = subset(df_hiv_final, select = names(df_hiv_final) %in% c("ISO3", "Number_of_cases_new_infections_gap_year", "cases_sdg", "Gap_in_nr_cases", "Number_of_deaths_gap_year", "deaths_sdg", "Gap_in_nr_deaths"))
write.csv(df_hiv_qa, file=file.path(output_path,"df_hiv_gap_forQA.csv"), na = "", row.names=FALSE)
...
# Save for QA
df_tb_qa = subset(df_tb_final, select = names(df_tb_final) %in% c("ISO3", "Number_of_cases_new_infections_gap_year", "cases_sdg", "Gap_in_nr_cases", "Number_of_deaths_gap_year", "deaths_sdg", "Gap_in_nr_deaths"))
write.csv(df_tb_qa, file=file.path(output_path,"df_tb_gap_forQA.csv"), na = "", row.names=FALSE)
...
# Save for QA
df_mal_qa = subset(df_malaria_final, select = names(df_malaria_final) %in% c("ISO3", "Number_of_cases_new_infections_gap_year", "cases_sdg", "Gap_in_nr_cases", "Number_of_deaths_gap_year", "deaths_sdg", "Gap_in_nr_deaths"))
write.csv(df_mal_qa, file=file.path(output_path,"df_mal_gap_forQA.csv"), na = "", row.names=FALSE)
