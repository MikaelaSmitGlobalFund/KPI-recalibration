...
# distance to GP gap at country-level. While there is code to make projections based on 
# continuation of recent trends it is only at the country level and does not feed into the 
# data shared with the KPI team. All portfolio data are generated by MCP and processed in an Excel 
...
# Bind latest information with model data
...
# Section 5. Now do 2021 to 2024 rate difference
...
write.csv(df_tb_gp_2030,file="/Users/mc1405/Dropbox/The Global Fund/KPI re-calibration/ROutput/TB_GP_2030_target.csv", row.names=FALSE)
